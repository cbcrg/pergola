...
plot_title <- switch (stat, count="Feeding bouts", mean="Mean intake per feeding bout", median='Median intake per feeding bout', sum='Accumulated intake', 
                      max='Maximun intake', '')
axis_title <- switch (stat, count="Number of bouts", mean='g', median='g', sum='g', max='g', 'no units' )
